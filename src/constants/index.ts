...
export const PERMISSIONLESS_DEPLOYER_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0xde16F65CA910EAb46ECE47D79f52BF720Cc6C650",
...
export const MASTER_REGISTRY_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0x2aad33fb8919DAC8Bacfd9d77e9424620363c1f7",
...
export const STABLECOIN_SWAP_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0x4ad75675ECD9903aD8b52f6B94a1AeF61e5D6450",
...
export const STABLECOIN_SWAP_V2_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0x3be5d277889705B01948C9c66A3C55CF8bb21BaC",
  [ChainId.HARDHAT]: "0xbf9fBFf01664500A33080Da5d437028b07DFcC55",
})
export const STABLECOIN_FARM_V2_ADDRESSES =
  "0x8354B8C3d80258937413916EA859CEbB6776c61b"
...
export const STABLECOIN_SWAP_V2_TOKEN_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.ARBITRUM]: "0xEE42e5FC577016B6D757c049ddC6004dE2900725",
...
export const CHILD_ORACLE_CONTRACT_ADDRESSES = buildAddresses({
  ...
  [ChainId.OPTIMISM]: "0x450441d90715c79870f48105c2ea445110E2F509",
  //  [ChainId.ARBITRUM]: "0x450441d90715c79870f48105c2ea445110E2F509",
})
...
export const PAYMENT_CONTRACT_ADDRESSES = buildAddresses({
  [ChainId.MAINNET]: "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",
  [ChainId.POLYGON]: "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174",
  [ChainId.GOERLI]: "0xFf0d118Ae1c41822dEF7FFDF0e883c81B04F6255",
  [ChainId.ROPSTEN]: "0xA4fe4981f7550884E7E6224F0c78245DC145b2F2",
  [ChainId.HARDHAT]: "0x9A676e781A523b5d0C0e43731313A708CB607508",
...
export const FARMS_MAP = [
  {
    ...
    lpToken: "0xEE42e5FC577016B6D757c049ddC6004dE2900725",
  ...
  },
  {
    ...
    lpToken: "0xCcF8FB2374b508986a527Deb89Ef6Ba340C83E46",
